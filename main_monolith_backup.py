...
# ---------------------------------------------------------
# PROPORTIONAL UI SCALING FOR ANDROID & DESKTOP
# Design values are written for standard 1080x1920 reference width.
# Dynamic scaling seamlessly adapts across all phone screen resolutions.
# ---------------------------------------------------------
DESIGN_WIDTH = 1080.0
